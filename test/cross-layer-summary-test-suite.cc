...
CrossLayerSummaryTestCase::DoRun()
{
    ...
    NS_TEST_ASSERT_MSG_EQ(firstInterval.macMpduDropCount, 1, "Wrong MAC MPDU drops");
    ...
    NS_TEST_ASSERT_MSG_EQ(firstInterval.applicationDropEventCount, 2, "Wrong application drops");
    NS_TEST_ASSERT_MSG_EQ(firstInterval.applicationDropBytes, 4096, "Wrong application drop bytes");
    NS_TEST_ASSERT_MSG_EQ(firstInterval.macMpduDropsByReason.size(), 1, "Wrong reason count");
    ...
    NS_TEST_ASSERT_MSG_EQ(firstInterval.applicationDropsByAgent.size(), 1, "Wrong agent count");
    ...
    NS_TEST_ASSERT_MSG_EQ(overall.phyMpduBytes, 0, "Wrong total PHY MPDU bytes");
    ...
    NS_TEST_ASSERT_MSG_EQ(overall.macMpduDropCount, 1, "Wrong total MAC MPDU drops");
    ...
    NS_TEST_ASSERT_MSG_EQ(overall.applicationDropEventCount, 2, "Wrong total application drops");
    NS_TEST_ASSERT_MSG_EQ(overall.applicationDropBytes, 4096, "Wrong total application drop bytes");
    NS_TEST_ASSERT_MSG_EQ(overall.macMpduDropsByReason.size(), 1, "Wrong total reason count");
    ...
    NS_TEST_ASSERT_MSG_EQ(empty.oneSecondIntervals.at(0).applicationToPhyDelay.sampleCount,
                          0,
                          "Empty interval has delay samples");
    NS_TEST_ASSERT_MSG_EQ(empty.oneSecondIntervals.at(0).applicationToPhyDelay.minimumUs,
                          0.0,
                          "Empty interval has a nonzero minimum");
    NS_TEST_ASSERT_MSG_EQ(empty.oneSecondIntervals.at(0).applicationTransmitThroughputMbps,
                          0.0,
                          "Empty interval has throughput");
    NS_TEST_ASSERT_MSG_EQ(empty.oneSecondIntervals.at(1).intervalDurationS,
                          0.5,
                          "Empty final interval has wrong duration");
    NS_TEST_ASSERT_MSG_EQ(empty.oneSecondIntervals.at(1).macMpduDropsByReason.empty(),
                          true,
                          "Empty interval has reasons");
    NS_TEST_ASSERT_MSG_EQ(empty.oneSecondIntervals.at(1).applicationDropsByAgent.empty(),
                          true,
                          "Empty interval has agent drops");
    NS_TEST_ASSERT_MSG_EQ(empty.overall.applicationTransmittedPayloadBytes,
                          0,
                          "Empty overall has application bytes");
    NS_TEST_ASSERT_MSG_EQ(empty.overall.applicationToPhyDelay.minimumUs,
                          0.0,
                          "Empty overall has a nonzero minimum");
    NS_TEST_ASSERT_MSG_EQ(empty.overall.averageChannelUtilizationPercent,
                          0.0,
                          "Empty overall has utilization");
    NS_TEST_ASSERT_MSG_EQ(empty.overall.macMpduDropsByReason.empty(),
                          true,
                          "Empty overall has reasons");
}
...
{
    return {new CrossLayerSummaryTestCase};
}
